...
class AncestorSpirit extends DudeCard {
    constructor(owner, cardData) {
        ...
        this.game.onceConditional('onDudeLeftLocation', { condition: event => event.card === this }, 
            () => this.removeFromGame());
        this.game.onceConditional('onCardLeftPlay', { condition: event => event.card === this && event.targetLocation !== 'out of game' }, 
            () => this.removeFromGame());
