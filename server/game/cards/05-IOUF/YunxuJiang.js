...
class YunxuJiang extends DudeCard {
    setupCardAbilities(ability) {
        this.persistentEffect({
            condition: () => this.isParticipating() && (this.game.shootout.shootoutLocation.locationCard.controller === this.controller || this.getGameLocation().isHome(this.controller)),
