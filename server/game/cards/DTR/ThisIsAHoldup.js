    ...
    setupCardAbilities(ability) {
        this.action({
            ...
            cost: ability.costs.boot(card =>
                card.getType() === 'dude' &&
                card.getLocationCard().owner !== card.controller 
                ),
            handler: context => {
                let robbedLocation = context.costs.boot.getLocationCard();
                ...
                this.game.resolveGameAction(GameActions.addBounty({ card: context.costs.boot, amount: robbedAmount }));
