...
describe('TriggeredAbilityWindow', function() {
    beforeEach(function() {
        ...
        this.abilityCard1 = createCard({ uuid: '111', title: 'The Card', controller: this.player1Spy });
        ...
        this.abilityCard2 = createCard({ uuid: '222', title: 'The Card 2', controller: this.player1Spy });
        ...
        this.abilityCard3 = createCard({ uuid: '333', title: 'Their Card', controller: this.player2Spy });
