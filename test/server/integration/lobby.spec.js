...
describe('lobby', function() {
    beforeEach(function() {
        ...
        this.cardService = jasmine.createSpyObj('cardService', ['getTitleCards', 'getAllCards', 'getRestrictedList']);
        ...
        this.cardService.getRestrictedList.and.returnValue(Promise.resolve([{ name: 'Default RL', banned: [], restricted: [] }]));
